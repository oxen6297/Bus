...
import sb.park.bus.feature.main.databinding.ItemStationInfoBinding
import sb.park.model.BusType
import sb.park.model.response.bus.StationInfoResponse

class StationInfoAdapter: ListAdapter<StationInfoResponse, StationInfoAdapter.ViewHolder>(diffCallback) {
